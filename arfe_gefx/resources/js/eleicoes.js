$(document).ready(function() {
    ...
    function btnCargo2012(ano, local) {
        $(".btn_cargo").click(function() {
            ...
            $("#content_ok").append("<div><a class='btn' target='_blank' href='arfe.html#RedesCargoUE_" + ano.trim() + "/draw-gefx/Network_" + local.trim() + "-" + $(this).html().trim() + "_" + ano.trim() + ".gefx'>Grafo Interativo</a></div>");
        });
    }
