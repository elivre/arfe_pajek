    ...
    i18n : {
        ...
        "tr" : {
            ...
            "browserErr" : "Tarayıcınız sayfayı doğru bir biçimde görüntüleyemiyor.<br />En son Firefox veya Chrome sürümünü kullanmanızı tavsiye ederiz."
             ...
             "pt-br" : {
            "search" : "Procurar um v&eacutertice",
            "nodeAttr" : "Atributos",
            "nodes" : "V&eacutertices",
            "inLinks" : "Ligações de entrada de  :",
            "outLinks" : "Ligações de saída para :",
            "undirLinks" : "Ligações não dirigidas para :",
            "lensOn" : "Ativar o modo lupa",
            "lensOff" : "Desativar o modo lupa",
            "edgeOn" : "Mostrar arestas",
            "edgeOff" : "Ocultar arestas",
            "zoomIn" : "Aproximar",
            "zoomOut" : "Distanciar",
            "browserErr" : 'Seu navegador não é capaz de mostrar esta p&aacute;gina corretamente.<br />Recomendamos utilizar aa &uacute;ltima versi&oacute;n de <a href="http://www.mozilla.com/" target="_blank">Firefox</a> o <a href="http://www.google.com/chrome/" target="_blank">Chrome</a>',
            "modularity_class" : "Clase de modularidade",
            "degree" : "Grau",
            "indegree" : "Grau de entrada",
            "outdegree" : "Grau de saída",
            "weighted degree" : "Grau ponderado",
            "weighted indegree" : "Grau ponderado de entrada",
            "weighted outdegree" : "Grau ponderado de saída",
            "closnesscentrality" : "Grau de proximidade",
            "betweenesscentrality" : "Grau de Intermediação",
            "authority" : "Pontuação de Autoridade (HITS)",
            "hub" : "Pontuação de hub (HITS)",
            "pageranks" : "Pontuação PageRank"
        },
    },
    lang : "en"
};
...
function loadGraph() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            GexfJS.gTitle = [( document.location.hash.length > 1 ? document.location.hash.substr(1) : GexfJS.params.graphFile )];
...
$(document).ready(function() {
    ...
    $("#graphtitle").html("<p><b>" + GexfJS.gTitle + "</b></p>");
